...
const SuccessBox: React.FC<SuccessBoxProps> = ({ projectName, targetPath }) => {
    return (
        <Box flexDirection="column" marginTop={1} marginLeft={2}>
            ...
            <Text color="green" bold>✨ Brewing complete! Your project is served hot.</Text>
            ...
            >
                <Box justifyContent="center" marginBottom={1}>
                    <Text bold color="cyan">☕ create-brew-app 2026</Text>
                </Box>
                ...
                <Box marginTop={2} justifyContent="center">
                    <Text italic dimColor>Happy Coding! May your brew never turn cold.</Text>
                </Box>
            </Box>
        </Box>
    );
